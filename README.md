...
- [MCP vs Skill, 이번엔 토큰으로 — 컨텍스트 비용을 직접 세봤다](https://zerry.co.kr/blog/mcp-vs-skill-token-cost)
- [오라클이 공지도 없이 무료 한도를 반토막 냈다 — 어제까지 3대 돌리던 서버를 오늘 2대로 줄였다](https://zerry.co.kr/blog/oracle-quietly-halved-always-free-arm)
